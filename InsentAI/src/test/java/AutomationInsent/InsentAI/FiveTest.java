...
public class FiveTest {
	...
	{
		//Add preset replies if email known then only it should display step 
     ...
     // click on add step
	  ...
	  //add new step button
	   ...
	   Actions g = new Actions(driver);
	    g.moveToElement(driver.findElement(By.xpath("//div[text()='Data Capture']"))).build().perform();
	    driver.findElement(By.xpath("//div[text()='Preset replies']")).click();  
	    
	    //adding email condition
	    
	    driver.findElement(By.xpath("//*[@id=\"root\"]/div[3]/div[2]/div/div/div[3]/div/form/div/div[2]/div/div[2]/div[2]/div[3]/div/div[1]/div/div[1]/div[2]/div[2]/div/div/div/div/div/span")).click();
	    driver.findElement(By.xpath("//*[@id=\"flowMoreDropdown\"]/div[2]/div")).click();
	    driver.findElement(By.xpath("//*[@id=\"root\"]/div[3]/div[2]/div/div/div[3]/div/form/div/div[2]/div/div[2]/div[2]/div[3]/div/div[1]/div/div[2]/div[1]/div/button/span/span[1]")).click();
	    driver.findElement(By.xpath("//*[@id=\"root\"]/div[3]/div[2]/div/div/div[3]/div/form/div/div[2]/div/div[2]/div[2]/div[3]/div/div[1]/div/div[2]/div[1]/div/div/div/div/div/div/div[2]/div[1]/div[3]/div[1]/input")).sendKeys("TRUE");
	    //preset button 1
	    
	    driver.findElement(By.xpath("//*[@name='states.0.flow.2.buttons.fields.0']")).click();
	    driver.findElement(By.xpath("//*[@name='states.0.flow.2.buttons.fields.0']")).clear();
	    driver.findElement(By.xpath("//*[@name='states.0.flow.2.buttons.fields.0']")).sendKeys("Option 1");
	    
	    
	    //preset button2 
	    driver.findElement(By.xpath("//*[@name='states.0.flow.2.buttons.fields.1']")).click();
	    driver.findElement(By.xpath("//*[@name='states.0.flow.2.buttons.fields.1']")).clear();
	    driver.findElement(By.xpath("//*[@name='states.0.flow.2.buttons.fields.1']")).sendKeys("Option 2");
